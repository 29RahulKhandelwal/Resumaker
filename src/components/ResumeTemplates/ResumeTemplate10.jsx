...
const ResumeTemplate10 = (props, ref) => {
        ...
        <>
            {
                profileData.map((profileElem, profileIndex) => {
                    return (
                        <div class="wrapper10 mt-lg-5" key={profileIndex} ref={ref}>
                            <div class="sidebar-wrapper10">
...
export default forwardRef(ResumeTemplate10);