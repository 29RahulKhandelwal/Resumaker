...
const ResumeTemplate12 = (props, ref) => {
        ...
        <>
            {
                profileData.map((profileElem, profileIndex) => {
                    return (
                        <div class="wrapper12 mt-lg-5" key={profileIndex} ref={ref}>
                            <div class="sidebar-wrapper12">
...
export default forwardRef(ResumeTemplate12);